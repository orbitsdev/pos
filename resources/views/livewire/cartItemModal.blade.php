        ...
        <div class="pos-checker-table overflow-y-auto shadow-inner">
            ...
            <table class="min-w-full divide-y divide-gray-300 ">
                ...
                <tr>
                    ...
                    <th scope="col" class="py-3 pl-3 pr-3 text-left text-sm font-semibold text-gray-900">Quantity</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-200 bg-white">
                ...
                <tr>
                    ...
                    <td class="whitespace-nowrap py-1 px-3 text-gray-600">{{ $item->product->id_number }}</td>
